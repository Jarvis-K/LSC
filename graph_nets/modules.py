...
class obsEncoder(snt.AbstractModule):
  ...
  def __init__(self,
    ...
    with self._enter_variable_scope():
      ...
      self._node_encoder_block = blocks.obsEncoderBlock(
...
class qEncoder(snt.AbstractModule):
  def __init__(self,
              #  conv_fn,
               mlp_fn,
               name="qEncoder"):
    super(qEncoder, self).__init__(name=name)

    with self._enter_variable_scope():

      self._node_encoder_block = blocks.qEncoderBlock(
          # conv_fn=conv_fn,
          mlp_fn=mlp_fn,
          name="q_encoder_block")
...
class LCommNet(snt.AbstractModule):
  def __init__(self,
    ...
    with self._enter_variable_scope():
      self._edge_block = blocks.LEdgeBlock(
          edge_model_fn=edge_model_fn,
          use_edges=False,
          use_receiver_nodes=False,
          use_sender_nodes=True,
      ...
      self._node_block = blocks.LNodeBlock(
          node_model_fn=node_model_fn,
          use_received_edges=True,
          use_sent_edges=False,
          use_nodes=True,
...
class HCommNet(snt.AbstractModule):
  def __init__(self,
    ...
    with self._enter_variable_scope():
      self._edge_block = blocks.HEdgeBlock(
          edge_model_fn=edge_model_fn,
          use_edges=False,
          use_receiver_nodes=False,
          use_sender_nodes=True,
          use_globals=False)
      self._node_block = blocks.HNodeBlock(
          node_model_fn=node_model_fn,
          use_received_edges=True,
          use_sent_edges=False,
          use_nodes=True,
...
class TCommNet(snt.AbstractModule):
  def __init__(self,
    ...
    with self._enter_variable_scope():
      self._edge_block = blocks.LEdgeBlock(
          ...
          use_globals=False,
          use_reverse_edges=True)
      self._edge_block2 = blocks.EdgeBlock(
          edge_model_fn=edge_model_fn,
          use_edges=False,
          use_receiver_nodes=False,
          use_sender_nodes=True,
  ...
  def _build(self, graph):
    # node_input = self._node_encoder_block(self._edge_block(graph))
    node_input = self._edge_block(self._edge_block2(graph))
    return self._node_block(node_input)
