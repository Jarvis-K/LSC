...
def play(env, n_round, map_size, max_steps, handles, models, print_every, eps=1.0, render=False, train=False,len_nei=40,MsgModels=None,num_bits_msg=5,msg_space=10,rewardtype='self',use_concate_mean_global=False,crps=[False,False],crp=False,selfplay=False,is_fix=False):
