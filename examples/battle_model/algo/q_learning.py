...
class MsgDQN(base.ValueNet):
    def __init__(self, sess, name, handle, env, len_nei,sub_len,msg_bits=5, memory_size=2**10, batch_size=64, update_every=5):

        super().__init__(sess, env, handle, name,len_nei, update_every=update_every,is_msg=True)
...
class DQN(base.ValueNet):
    def __init__(self, sess, name, handle, env, sub_len,len_nei, memory_size=2**10, batch_size=64, update_every=5):
...
class GDQN(base.GCrpNet):
    def __init__(self, sess, name, handle, env, sub_len,len_nei=6, memory_size=2**10, batch_size=64, update_every=5,isHie=False):

        super().__init__(sess, env, handle, name,len_nei=len_nei, update_every=update_every,isHie=isHie)
